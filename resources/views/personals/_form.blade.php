    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <div class="form-group has-success">
          ...
          <div class="col-md-7">
            <input id="serial" type="serial" class="form-control" name="serial" placeholder="Serial" value="{{ old('serial') }}" required>
        ...
        <div class="form-group has-success">
          ...
          <div class="col-md-7">
            ...
            {{-- {!! Form::textarea("nrc", null, ['class'=>'form-control', 'id'=>'nrc', 'name'=>'nrc', 'value'=>'{{ old('nrc') }}', 'placeholder'=>'၈/တတတ(နိုင်)၁၅၁၇၁၅', 'rows'=>'2', 'required'=>'required']) !!} --}}
            @if ($errors->has('nrc'))
                <span class="help-block">
