<!-- Modal -->
{!! Form::model($leave, ['route'=>['leaves.update', $leave->id], 'method'=>'PUT']) !!}
...
<div class="modal fade" id="LeaveModel{{ $leave->id }}" tabindex="-1" role="dialog" aria-labelledby="LeaveModelLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="card-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title" id="LeaveModelLabel">ခွင့်ပြင်မည်</h4>
        </div>
